...
.review-assist{margin-bottom:12px;padding:15px;border:1px solid var(--op-border,#334155);border-radius:17px;background:var(--op-card,#0f172a)}.review-progress{display:flex;flex-wrap:wrap;gap:6px;margin-top:9px}.review-step{padding:5px 7px;border-radius:999px;background:rgba(148,163,184,.08);font-size:9px;font-weight:850}.review-step.done{background:#052e16;color:#bbf7d0}.review-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:12px}.review-column{padding:10px;border-radius:13px;background:rgba(148,163,184,.055)}.review-column-head{display:flex;justify-content:space-between;gap:8px;align-items:center}.review-column h3{margin:0;font-size:11px}.review-count{min-width:23px;height:23px;display:grid;place-items:center;border-radius:999px;background:rgba(148,163,184,.1);font-size:9px;font-weight:900}.review-items{display:grid;gap:7px;margin-top:9px}.review-item{padding:8px;border-radius:10px;background:rgba(148,163,184,.065)}.review-item-scope{font-size:8px;font-weight:900;color:#93c5fd}.review-item-title{display:block;margin-top:2px;color:inherit;text-decoration:none;font-size:10px;font-weight:900}.review-item-meta{margin-top:3px;font-size:9px;line-height:1.4;color:var(--op-muted,#94a3b8)}.review-actions{display:flex;gap:7px;align-items:center;flex-wrap:wrap;margin-top:11px}.review-link{display:inline-block;padding:7px 10px;border:1px solid #1d4ed8;border-radius:9px;background:#172554;color:#dbeafe;text-decoration:none;font-size:10px;font-weight:900}
...
@media(max-width:900px){.metrics{grid-template-columns:repeat(3,minmax(0,1fr))}.daily-plan-grid,.review-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.executive-grid,.intel-grid,.center-grid{grid-template-columns:1fr}}
@media(max-width:620px){.head,.row,.panel-head{display:grid}.metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.daily-plan-grid,.review-grid,.context-counts{grid-template-columns:1fr}.quick-links,.proposal-prepare,.proposal-prepare.service{grid-template-columns:1fr}}
