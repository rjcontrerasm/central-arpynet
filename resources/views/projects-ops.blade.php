...
.brand{font-weight:850;letter-spacing:-.03em}.hero{align-items:end;margin-bottom:18px}h1{margin:0;font-size:clamp(31px,7vw,48px);line-height:.96;letter-spacing:-.05em}.subtitle,.muted,.empty{color:#94a3b8}.subtitle{margin-top:8px;font-size:13px}
.primary-link{padding:10px 13px;border:1px solid #1d4ed8;border-radius:11px;background:#172554;color:#dbeafe;font-size:12px;font-weight:800}
